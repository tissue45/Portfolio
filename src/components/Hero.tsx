...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen pt-24 md:pt-28 relative overflow-hidden bg-gradient-to-b from-rose-50/70 via-white to-violet-50/40">
      <div className="absolute inset-0 bg-gradient-to-br from-rose-100/40 via-transparent to-violet-100/40" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 items-center min-h-[calc(100vh-7rem)]">
          ...
          >
            <div className="inline-flex items-center rounded-full border border-rose-200 bg-white px-4 py-1 text-sm text-rose-500 mb-5 shadow-sm">
              Portfolio 2026
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                className="apple-button bg-gradient-to-r from-rose-500 to-violet-500 text-white px-8 py-4 rounded-2xl font-semibold shadow-lg"
              >
                프로젝트 보기
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.04 }}
                whileTap={{ scale: 0.96 }}
                className="apple-button border-2 border-rose-300 text-rose-500 px-8 py-4 rounded-2xl font-semibold hover:bg-rose-500 hover:text-white transition-colors duration-200"
              >
                연락하기
              </motion.a>
            </div>
          ...
          >
            ...
            <div className="mt-4 bg-white/90 dark:bg-apple-gray-800/90 border border-rose-100 dark:border-apple-gray-700 rounded-3xl p-6 shadow-xl backdrop-blur-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-xl bg-rose-50 dark:bg-apple-gray-700 p-3">
                  <p className="text-xs text-apple-gray-500 dark:text-apple-gray-400">위치</p>
                  <p className="text-sm font-medium text-apple-dark dark:text-white">대한민국 의정부</p>
                </div>
              </div>
            </div>
          </motion.div>
